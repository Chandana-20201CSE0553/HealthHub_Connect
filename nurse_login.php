        ...
        <header id="header" class="header" >
         ...
         <section id="hero-2" class="hero-section division">
            <div class="slider blue-nav">
               <ul class="slides">
                  <li id="slide-1">
                     <img src="images/slider-1.jpg" alt="slide-background">
                     <div class="caption d-flex align-items-center left-align">
                        <div class="container">
                           <div class="row">
                              <div class="col-md-9 col-lg-7">
                                 <div style="width:420px; background:black; color:white; position:relative; border-radius:20px; padding:30px 40px;">
                                    <form action="nurse_login_process.php" method="POST">
                                       <center>
                                          <h3 style="color:white;font-family:calligrapher;">NURSE LOGIN</h3>
                                          <div  style="width:100%; height:50px; margin:30px 0;" >
                                             <input type="text" placeholder="Enter Nurse ID" name="nurse_id" required style="width:100%; height:100%; background:white; border:none; outline:none;color:black; border: 2px solid rgba(255,255,255,.2); border-radius:40px; padding:20px 45px 20px 20px;  " >
                                          ...
                                          <input type="submit" name="submit" value="submit" class="btn btn-light" style="width:100px;height:80px;border-radius:150px;border-color:white">
                                       </center>
                                    </form>
                                 </div>
                              </div>
