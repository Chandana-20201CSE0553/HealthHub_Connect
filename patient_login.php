         ...
         <section id="hero-2" class="hero-section division">
            <div class="slider blue-nav">
               <ul class="slides">
                  ...
                  <li id="slide-3">
                     <img src="images/2.jpg" alt="slide-background">
                              ...
                              <div class="col-md-9 col-lg-7">
                                 ...
                                 <div style="width:420px; background:black; color:white; position:relative; border-radius:20px; padding:30px 40px;">
                                    <form action="patient_login_process.php" method="POST">
                                       <center>
                                          <h3 style="color:white;font-family:calligrapher;">PATIENT LOGIN</h3>
                                          <div  style="width:100%; height:50px; margin:30px 0;">
                                             <input type="text" placeholder="Enter Patient ID" name="patient_id" required style="width:100%; height:100%; background:white; border:none; outline:none;color:black; border: 2px solid rgba(255,255,255,.2); border-radius:40px; padding:20px 45px 20px 20px;  " >
