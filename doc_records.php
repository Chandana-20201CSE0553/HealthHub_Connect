                           ...
                           <nav class="wsmenu clearfix">
                              <ul class="wsmenu-list">
                                 <li aria-haspopup="true">
                                    <a href="doc_register.php"><font size="4">Home </font></a>
                                 </li>
                                 <li aria-haspopup="true">
                  ...
                  <li id="slide-1">
                     <img src="images/coloured-background-design_1107-190.avif" alt="slide-background">
                        ...
                        <div class="container">
                            <br>
                                                  <div  >
                                 <input type="text" class="form-control" id="searchInput" onkeyup="searchTable()"  placeholder="Search By Doctor ID" required style="border-color:black;border-radius:10px;width:40%;">
                              </div>
<br>

                  
         <center>  <h3>DOCTOR RECORDS </h3></center>
              <br>
              <center>
									...
									if(mysqli_num_rows($query)>0){
										...
										?>
                                        	<tr style="color:black;">
												...
												<td>
													<a href="doc_records_delete.php?id=<?php echo $id;?>"><input type="submit" value="Delete" class="update"></a>
												</td>
