   ...
   <body>
      ...
      <div id="page" class="page">
         ...
         <center>  <h3>EDIT CONTACT INFORMATION  </h3></center>
              <br><br>
              <center>
                                 <form action="edit_nurse.php" method="post" style="width:50%; padding: 20px;background-color:rgba(255, 106, 89, 0.1); border: 1px solid #ccc; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                            <div class="page-content" style="padding:50px; ">
                              ...
                              <br>
                          <input type="submit"class="btn btn-outline-success"  name="submit"style="padding:15px;border-color:black;">
                    ...
                    <?php 
						if(isset($_POST['submit'])){
							...
							$email=$_POST['email'];
							$query=mysqli_query($con,"UPDATE `nurse` SET `contact`='$contact',`address`='$address',`email`='$email' WHERE `nurse_id`='$nurse_id'");
								if($query){
									echo'<script>alert("updated successfully");window.location.assign("nurse.php");</script>';
								}
