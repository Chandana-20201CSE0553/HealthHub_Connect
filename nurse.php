   ...
   <body>
      ...
      <div id="page" class="page">
         <header id="header" class="header" >
                           ...
                           <nav class="wsmenu clearfix">
                              <ul class="wsmenu-list">
                                 <li aria-haspopup="true">
                                    <a href="nurse.php"><font size="4">Home </font></a>
                                 </li>
                                 <li aria-haspopup="true">
                                    <a href="patient_records_for_nurse.php"><font size="4">Patient Records </font></a>
                                 </li>
                                     
                                 
                                 <li aria-haspopup="true">
                                    <a href="nurse_logout.php"><font size="4">Logout</font></a>
                                 </li>
               ...
               ?>
         <center>  <h3>Greetings : <?php echo $row['nurse_id']; ?>  </h3></center>
              <br>
            <center>
                <?php 
                ...
                ?>
                     ...
                     <div class="col-md-6 grid-margin stretch-card" >
                        <div class="card tale-bg" style="padding:20px ;background-color:rgba(255, 106, 89, 0.1);border-radius:20px;border-color:black;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);color:black;font-size:23px;">
                           ...
                           <hr>
                           <br>
                          <center> <button type="button"class="btn btn-outline-primary" style="padding:15px;border-color:black;width:15%;"><a href="edit_nurse.php"><b><font color="black" size="4" >Edit</font></b></a></button></center>
                        </div>
                     </div>
                  </center><br><br>
