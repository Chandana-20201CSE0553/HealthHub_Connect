   ...
   <body>
      ...
      <div id="page" class="page">
         ...
         <center>  <h3>EDIT CONTACT INFORMATION  </h3></center>
              <br><br>
              <center>
         <form action="#" method="post" style="width:50%; padding: 20px;background-color:rgba(255, 106, 89, 0.1); border: 1px solid #ccc; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
...
<?php 
						if(isset($_POST['submit'])){
							...
							$email=$_POST['email'];
							$query=mysqli_query($con,"UPDATE `doctor` SET `contact`='$contact',`address`='$address',`email`='$email' WHERE `doctor_id`='$doctor_id'");
								if($query){
									echo'<script>alert("updated successfully");window.location.assign("doctor.php");</script>';
								}
